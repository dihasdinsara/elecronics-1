      ...
      <div className="container mx-auto px-4">
        <div className="bg-white shadow-md rounded-lg p-8 text-center">
          ...
          <p className="text-gray-700 text-lg mb-8">
            ...
            educational content and resources for free. By supporting us, you
            are enabling us to reach more students and make a greater impact in
            the field of IoT and web development.
          </p>
          <div className="flex justify-center space-x-4 mb-4">
            <a
              href="https://wa.me/0719599991"
              target="_blank"
          ...
          <p className="mt-4 text-sm text-gray-500">
            We appreciate your kindness and generosity in supporting our
            mission.
          </p>
        </div>
      </div>
